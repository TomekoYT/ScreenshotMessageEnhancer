...
//?}
{
                    ...
                    .then(
                        argument("pos", IntegerArgumentType.integer())
                            .executes { context ->
                                ...
                                ScreenshotManager.uploadScreenshot(pos)
                                1
                            }
                    )
            )
    ...
    //? if forge {
    /*const val COMMAND_USAGE = "/${Constants.SCREENSHOT_UPLOAD_COMMAND} <pos>"

    override fun getCommandName(): String = Constants.SCREENSHOT_UPLOAD_COMMAND
    ...
    override fun processCommand(sender: ICommandSender, args: Array<String>) {
        ...
        ScreenshotManager.uploadScreenshot(args[0].toInt())
    }
